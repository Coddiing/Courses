...
trait Tables {
  ...
  final case class UsersRow(userName: String, userPass: String, email: String = "dummy@nowhere.com", created: Option[java.sql.Timestamp] = None, lastlogin: Option[java.sql.Timestamp] = None)
